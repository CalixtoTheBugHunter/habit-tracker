export const ptBR = {
  ...
  habitList: {
    ...
    noFilterResults: 'Nenhum hábito corresponde aos seus filtros.',
  ...
  habitFilter: {
    label: 'Buscar, filtrar e ordenar hábitos',
    searchLabel: 'Buscar hábitos',
    searchPlaceholder: 'Buscar por nome ou descrição...',
    statusLabel: 'Filtrar por status',
    status: {
      all: 'Todos',
      completedToday: 'Concluídos hoje',
      notCompletedToday: 'Não concluídos hoje',
      activeStreak: 'Sequência ativa',
    },
    streakLabel: 'Filtrar por sequência',
    streakChipAria: 'Filtrar por sequência: {label}',
    streak: {
      all: 'Todas',
      zero: '0',
      oneToSeven: '1–7',
    ...
    clearAria: 'Limpar todas as seleções de busca e filtro',
  },
  archivedHabits: {
